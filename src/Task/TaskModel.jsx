...
export default function TaskModel({ onSave, taskToUpdate, handleCloseClick }) {
  ...
  const [isAdd, _] = useState(Object.is(taskToUpdate, null));

  return (
    <div className=" bg-black w-full h-full absolute top-0 left-0 z-10 bg-opacity-70">
